...
export default function Footer() {
  return (
    <div className="flex flex-col bg-fuchsia-500 max-h-max p-10">
      <div className="bg-fuchsia-200 text-fuchsia-900 rounded-md w-full my-6 p-10 self-center">
      ...
      <div className="bg-fuchsia-200 rounded-md min-w-max px-20 py-3 mt-6 self-center">
        <p className="mb-3 text-fuchsia-900">Follow us</p>
      ...
      <p className="w-full border-t-2 border-fuchsia-200 text-fuchsia-200 mt-10 pt-3">
